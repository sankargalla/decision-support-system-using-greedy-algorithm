...
from utils.main import multinomial_logit, user_accuracy
from tqdm import tqdm

from results.utils_plot import command_line
...
METHODS = ['SE', 'UCB1', 'Counterfactual SE', 'Counterfactual UCB1', f'Greedy (k=16)']
